export const presentsList = [
  {
    name: "Lua de Mel 2026",
    description: "Por motivos de bolso e agenda, resolvemos adiar a nossa Lua de Mel para o próximo ano! Como moramos no RS, estamos planejando visitar Gramado e a rota dos vinhos em Bento Gonçalves. Provavelmente iremos no inverno, mas sem data definida.",
    photo: "lua-de-mel.jpeg"
  },
  {
    name: "Trocar o Uno",
